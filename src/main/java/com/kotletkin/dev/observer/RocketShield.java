...
public class RocketShield implements Observer, DisplayMonitor {
    private final Subject subject;
    private String missleName;
    private String missleX;
    private String missleY;

    public RocketShield(Subject subject) {
    ...
    @Override
    public void display() {
        System.out.println("RocketShield get data about missle: Missle Name: " + missleName +
